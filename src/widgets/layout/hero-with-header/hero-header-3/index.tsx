  ...
  return (
    <section class="bg-white ">
      <nav class="container p-6 mx-auto lg:flex lg:justify-between lg:items-center">
        ...
        <div class="absolute inset-x-0 z-20 w-full px-6 py-4 transition-all duration-300 ease-in-out bg-white shadow-md lg:shadow-none  lg:mt-0 lg:p-0 lg:top-0 lg:bg-transparent lg: lg:relative lg:w-auto lg:opacity-100 lg:translate-x-0 lg:flex lg:items-center">
          ...
          <a
            class="block px-5 py-2 mt-4 text-sm text-center text-gray-700 capitalize transition-colors duration-300 transform border rounded-md   lg:mt-0 hover:bg-gray-100 lg:w-auto"
            href="#"
          >
            Contact Us
          </a>
      ...
      <div class="container px-6 py-16 mx-auto text-center">
        <div class="max-w-lg mx-auto">
          ...
          <div class="w-full max-w-sm mx-auto mt-6 bg-transparent border rounded-md  focus-within:border-blue-400 focus-within:ring focus-within:ring-blue-300  focus-within:ring-opacity-40">
...
export default HeroWithHeader3;
