const Footer4 = () => {
  return (
    <div class="relative mt-16 bg-purple-600">
      <svg
        class="absolute top-0 w-full h-6 -mt-5 sm:-mt-10 sm:h-16 text-purple-600"
      ...
      <div class="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
          ...
          <div class="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4">
            <div>
              ...
              <ul class="mt-2 space-y-2">
                <li>
                  <a href="/" class="transition-colors duration-300 text-purple-50 hover:text-white">
                    News
                  </a>
                </li>
                <li>
        ...
        <div class="flex flex-col justify-between pt-5 pb-10 border-t border-purple-200 sm:flex-row">
          ...
          <div class="flex items-center mt-4 space-x-4 sm:mt-0">
            <a href="/" class="transition-colors duration-300 text-purple-100 hover:text-white">
